...
-- {{{ Menu
--local myawesomemenu =  { "hotkeys", function() return false, hotkeys_popup.show_help end },
--    { "arandr", "arandr" },
--}
...
awful.spawn.with_shell("nordvpn connect")
